...
INSERT INTO `tiku_question` VALUES ('6', '2', '2', '71', '1', '<p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; word-wrap: break-word; line-height: 1.5;\"><span style=\"vertical-align: middle;\">1. 洋葱根尖和小鼠骨髓细胞都能用于观察细胞有丝分裂，比较实验操作和结果，叙述正确的是(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; )</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; word-wrap: break-word; line-height: 1.5; display: inline-block;\"><span class=\"prefix\" style=\"vertical-align: middle; padding-right: 10px;\">A</span><span style=\"vertical-align: middle;\">都需要用盐酸溶液使细胞相互分离</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; word-wrap: break-word; line-height: 1.5; display: inline-block;\"><span class=\"prefix\" style=\"vertical-align: middle; padding-right: 10px;\">B</span><span style=\"vertical-align: middle;\">都需要用低倍镜找到分裂细胞再换高倍镜观察</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; word-wrap: break-word; line-height: 1.5; display: inline-block;\"><span class=\"prefix\" style=\"vertical-align: middle; padding-right: 10px;\">C</span><span style=\"vertical-align: middle;\">在有丝分裂中期都能观察到染色体数目加倍</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; word-wrap: break-word; line-height: 1.5; display: inline-block;\"><span class=\"prefix\" style=\"vertical-align: middle; padding-right: 10px;\">D</span><span style=\"vertical-align: middle;\">在有丝分裂末期都能观察到细胞板</span></p>', '<p><span style=\"color: rgb(51, 51, 51); font-family: 微软雅黑, &quot;Hiragino Sans GB&quot;, arial, helvetica, clean; font-size: 14px; background-color: rgb(255, 255, 255);\">盐酸只能使植物细胞相互分离开来，A错误；若要用高倍镜，都需要用低倍镜找到分裂细胞再换高倍镜观察，B正确；有丝分裂中期着丝点没有断裂，染色体没有加倍，C错误；细胞板只在植物细胞有丝分裂末期出现，D错误。</span></p>', '<p><span style=\"color: rgb(51, 51, 51); font-family: 微软雅黑, &quot;Hiragino Sans GB&quot;, arial, helvetica, clean; font-size: 14px; background-color: rgb(255, 255, 255);\">依据细胞有丝分裂的观察及动植物细胞有丝分裂的区别逐项分析．</span></p>', '测试题目', '2018', '5');
